    ...
    <AccordionContainer>
      ...
      >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography>what is ShalFlix</Typography>
        </AccordionSummary>
        <Collapse in={expanded === "panel1"} timeout="auto" unmountOnExit>
          <AccordionDetails>
            <Typography>
              ShalFlix is a streaming service that offers a wide variety of
      ...
      >
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography>How much does ShalFlix cost?</Typography>
        </AccordionSummary>
        <Collapse in={expanded === "panel3"} timeout="auto" unmountOnExit>
          <AccordionDetails>
            <Typography>
              Watch ShalFlix on your smartphone, tablet, Smart TV, laptop, or
      ...
      >
        <AccordionSummary aria-controls="panel3d-content" id="panel4d-header">
          <Typography>What can i watch on ShalFlix?</Typography>
        </AccordionSummary>
      ...
      >
        <AccordionSummary aria-controls="panel5d-content" id="panel5d-header">
          <Typography>Is ShalFlix good for kids?</Typography>
        </AccordionSummary>
        <Collapse in={expanded === "panel5"} timeout="auto" unmountOnExit>
          <AccordionDetails>
            <Typography>
              The ShalFlix Kids experience is included in your membership to
